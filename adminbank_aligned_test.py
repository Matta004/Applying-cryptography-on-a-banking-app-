...
class Bank:
    ...
    def accept_request(self, request):
        self.bank.send_approval_email(email, account_id, password)  # Direct call
        ...
        try:
            ...
            email_thread = self.send_approval_email, args=(email, account_id, password)
            # Direct call to send_approval_email for debugging purposes
            email_thread.start()
            ...
            self.send_approval_email(email, account_id, password)  # Direct call
